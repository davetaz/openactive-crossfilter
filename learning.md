...
Use the `Fork` button at the bottom right of the page (or use CTRL+S on your keyboard); this creates an exact copy of the pen that you can then make changes to.
